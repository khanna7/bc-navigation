...
diagnosis <- function(net.f, social, time_step){
  ...
  nav_start_time <- net.f %v% "navigation_start_time"
  nav_end_time <- net.f %v% "navigation_end_time"
...
#TODO stop navigation here (either way navigation ends with diagnostic testing)
  ...
  net.f %v% "navigation_start_time" <- nav_start_time
  net.f %v% "navigation_end_time" <- nav_end_time
